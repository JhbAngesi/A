...
public class PlayerActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private cn.student.musicplayer.view.RotateAnimator rotateAnimator;
    ...
    private void initActivity() {
        ...
        //初始化动画
        rotateAnimator = new cn.student.musicplayer.view.RotateAnimator(this, musicImgView, needleView);
        rotateAnimator.set_Needle();

        // 绑定service，从onServiceConnected()回调方法接受Binder
    ...
    private MusicService.OnStateChangeListenr listenr = new MusicService.OnStateChangeListenr() {
        ...
        public void onPlayProgressChange(long played, long duration) {
            ...
            totalTimeView.setText(Utils.formatTime(duration));//总时间
            nowTimeView.setText(Utils.formatTime(played));//当前时间
